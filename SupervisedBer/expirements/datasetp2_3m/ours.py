...
from expirements.utils import sample_from_space, make_combinations_from_config
...
config = {
    "loss_type": ["s&t&u&c"],
    "experiment_name": ["p2-s&t&u&c"],
    "hidden_dim": [25],    "drop_prob": [0.2],
    "hidden_layers": [4],
    ...
    "epochs": [100],
    "coef":[1,10,100],
    "save_weights": [os.path.join(parent_dir, "weights/ber/dataset-p2_3m")],
    "plots_dir": [os.path.join(parent_dir, "plots/ours/dataset-p2_3m/")]
}
