...
def make_dataset_5(parent_dir):
    ...
    adata.write_h5ad(os.path.join(parent_dir, 'dataset_5_scaled.h5ad'))
    print("write")
    return adata

def get_dataset():
    data_dir = r"C:\Users\avrah\OneDrive\שולחן העבודה\batch_effect\dataset5"
    make_dataset_5(data_dir)
    adata = sc.read_h5ad(os.path.join(data_dir, 'dataset_5_scaled.h5ad'))
...
if __name__ == "__main__":
    filepath = r"adata_dataset_5_norm.h5ad"
