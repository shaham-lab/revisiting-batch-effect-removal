...
config = {
    ...
    "plots_dir": [os.path.join(parent_dir, "plots/pca_correct/dataset1-benchmark-new/")]
}
...
if __name__ == "__main__":
    ...
    for config in configurations:
        ...
        adata_target_calibrated_src.write(os.path.join(config["plots_dir"],'pca_method_dataset_1.h5ad'))
