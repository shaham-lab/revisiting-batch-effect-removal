...
config = {
    ...
    "code_dim": [2056],        # Dimension of the encoded code representation
    ...
    "batch_size": [256,128, 64],  # or tune.choice([<list values>])
    "epochs": [40],
    "coef_1": [1, 2, 5],
    "save_weights": [os.path.join(parent_dir, "weights/ber/dataset1-benchmark/code_space")],
    "plots_dir": [os.path.join(parent_dir, "plots/ours/dataset1-benchmark/code_space")]
}
...
if __name__ == "__main__":
    ...
    for config in configurations:
        try:
            ...
            adata_code_space.write_h5ad(os.path.join(config["plots_dir"],"code_src.h5ad"), compression='gzip')
