...
config = {
    ...
    "epochs": [40],
    "coef_1": [1, 2, 5],
    "save_weights": [os.path.join(parent_dir, "weights/ber/dataset2-benchmark/code_space")],
    "plots_dir": [os.path.join(parent_dir, "plots/ours/dataset2-benchmark/code_space")]
}
