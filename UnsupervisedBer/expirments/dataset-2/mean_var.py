...
config = {
    ...
    "plots_dir": [os.path.join(parent_dir, "plots/mean_varience/dataset2-benchmark-new/")]
}
...
if __name__ == "__main__":
    ...
    for config in configurations:
        ...
        adata_target_calibrated_src.write(os.path.join(config["plots_dir"],'mean_var_dataset_2.h5ad'))
