...
config = {
    ...
    "epochs": [40],
    "coef_1": [10],
    "save_weights": [os.path.join(parent_dir, "weights/ber/dataset2-benchmark-new/")],
    "plots_dir": [os.path.join(parent_dir, "plots/pca_correct/dataset2-benchmark-new/")]
}
...
if __name__ == "__main__":
    ...
    for config in configurations:
        ...
        corected_data,_ = batch_correction_pca(adata.X,adata.obs['batch'].astype('int'))
        ...
        adata_target_calibrated_src.write(os.path.join(config["plots_dir"],'pca_method_dataset_2.h5ad'))
