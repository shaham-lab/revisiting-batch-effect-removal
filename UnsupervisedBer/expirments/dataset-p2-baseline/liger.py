...
plots_dir = r"../plots/liger/dataset-p2-baseline/"
os.makedirs(plots_dir, exist_ok=True)

# Load your data into two numpy arrays
src_path = '../../data/Cytof/Person2Day1_baseline.csv'
target_path = '../../data/Cytof/Person2Day2_baseline.csv'
src_path_label = '../../data/Cytof/Person2Day1_baseline_label.csv'
